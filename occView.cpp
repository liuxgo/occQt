...
void OccView::dragEvent(const int x, const int y)
{
    ...
    Graphic3d_Vec2i thePntMin(myXmin, myYmin);
    Graphic3d_Vec2i thePntMax(x, y);
    myContext->SelectRectangle(thePntMin, thePntMax, myView);
    emit selectionChanged();
}

void OccView::multiDragEvent(const int x, const int y)
{
    // myContext->SelectRectangle(myXmin, myYmin, x, y, myView);
    Graphic3d_Vec2i thePntMin(myXmin, myYmin);
    Graphic3d_Vec2i thePntMax(x, y);
    myContext->SelectRectangle(thePntMin, thePntMax, myView);
    emit selectionChanged();
